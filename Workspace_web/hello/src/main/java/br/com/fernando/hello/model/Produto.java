package br.com.fernando.hello.controller;
...
public class HelloController {
	...
	public String inserirNovoProduto(Produto novo) {
		System.out.println("Recebido: "+novo.getId()+ " "+novo.getDescricao()+ " "+novo.getPreco()+ " "+novo.getQtde());		
		return "sucesso";
	}
